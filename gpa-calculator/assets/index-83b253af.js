  ...
  setup(__props) {
    ...
    const GPA = computed(() => {
      ...
      for (const item of lines.list) {
        ...
        if (item.score === void 0 && item.gpa === void 0) {
          continue;
        } else {
          if (item.score !== void 0) {
        ...
        if (gpa !== null) {
          ...
          const rule = rules.list.find((rule2) => rule2.scoreFrom <= score && score <= rule2.scoreTo);
          if (rule) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createVNode(VCol, { cols: 4 }, {
              default: withCtx(() => [
                createVNode(VBtn, {
                  block: true,
                  color: "success",
                  onClick: _cache[0] || (_cache[0] = ($event) => uploadFileInput.value.click())
                }, {
                  default: withCtx(() => [
                    createTextVNode("从文件导入")
                  ]),
                  _: 1
                }),
        ...
        createVNode(VRow, null, {
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_2, [
              createTextVNode(" 平均绩点(按学分加权): "),
              createBaseVNode("span", _hoisted_3, toDisplayString(GPA.value), 1)
            ])
          ]),
          _: 1
        }),
          ...
          return openBlock(), createBlock(VRow, { key: index }, {
            default: withCtx(() => [
              ...
              createVNode(VCol, { cols: 2.4 }, {
                default: withCtx(() => [
                  createVNode(VTextField, {
                    modelValue: item.course,
                    "onUpdate:modelValue": ($event) => item.course = $event,
              ...
              createVNode(VCol, { cols: 2.4 }, {
                default: withCtx(() => [
                  createVNode(VTextField, {
                    modelValue: item.credit,
                    "onUpdate:modelValue": ($event) => item.credit = $event,
                    class: "centered-input",
                    color: "primary",
                    variant: "underlined",
                    density: "compact",
        ...
        createVNode(VDialog, {
          ...
          "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => dialog.value.show = $event),
          width: "500"
        }, {
          default: withCtx(() => [
                ...
                createVNode(VCardActions, null, {
                  default: withCtx(() => [
                    ...
                    createVNode(VBtn, {
                      color: "error",
                      variant: "text",
                      onClick: _cache[2] || (_cache[2] = ($event) => dialog.value.show = false)
                    }, {
                      default: withCtx(() => [
                        createTextVNode(" 取消")
                      ]),
