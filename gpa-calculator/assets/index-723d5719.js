import { e as defineStore, i as i18n, p as propsFactory, f as deepEqual, m as makeComponentProps, h as makeTagProps, j as makeThemeProps, k as makeVariantProps, l as genericComponent, n as provideTheme, q as provideDefaults, t as toRef, u as useRender, a as createVNode, I as IconValue, E as EventProp, r as makeBorderProps, s as makeDensityProps, v as makeElevationProps, x as makeRoundedProps, y as makeRouterProps, z as makeSizeProps, R as Ripple, A as useLocale, B as useBorder, C as useVariant, D as useDensity, F as useElevation, G as useRounded, H as useSize, J as useProxiedModel, K as useLink, L as computed, M as withDirectives, N as resolveDirective, O as genOverlays, V as VExpandXTransition, P as VIcon, Q as VDefaultsProvider, S as vShow, T as Fragment, U as VAvatar, W as mergeProps, X as omit, Y as useScopeId, Z as getUid, _ as ref, $ as inject, a0 as shallowRef, a1 as provide, a2 as watch, a3 as focusChild, a4 as useResizeObserver, a5 as watchEffect, a6 as useDisplay, a7 as createRange, a8 as clamp, a9 as makeDimensionProps, aa as getCurrentInstance, ab as useDimension, ac as useToggleScope, ad as convertToUnit, ae as onMounted, af as onScopeDispose, ag as makeItemsProps, ah as makeTransitionProps, ai as useItems, aj as VList, ak as VListItem, b as createTextVNode, al as wrapInArray, am as useBackgroundColor, an as filterInputAttrs, ao as useTheme, o as openBlock, c as createElementBlock, d as createBaseVNode, w as withCtx, ap as unref, aq as isRef, ar as block0 } from "./index-8021c353.js";
import { m as makeVOverlayProps, V as VDialogTransition, a as VMenuSymbol, b as VOverlay, f as forwardRefs, g as getScrollParent, c as makeVTextFieldProps, u as useForm, d as VTextField, e as makeVInputProps, h as useFocus, i as VInput, j as VCol, k as VRow } from "./VTextField-d91261c1.js";
import { V as VCheckboxBtn, m as makeVSelectionControlProps, a as VSelectionControl } from "./VCheckboxBtn-a708d9a6.js";
import { m as makeGroupProps, u as useGroup, a as makeGroupItemProps, b as useGroupItem, c as makeLocationProps, d as makePositionProps, e as useLocation, f as usePosition, g as useLoader, L as LoaderSlot, V as VProgressCircular } from "./position-eeb180c1.js";
const useI18n = defineStore("i18n", {
  state: () => ({
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const lang = langs[0];
    watch(lang, () => i18n2.changeLang(langs.find((i) => i.title === lang.value)?.code));
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", null, [
          createTextVNode(" 通用 "),
          createVNode(VSheet, { class: "rounded-lg" }, {
            default: withCtx(() => [
              createVNode(VCol, null, {
                default: withCtx(() => [
                  createVNode(VRow, { style: { "height": "60px" } }, {
                    default: withCtx(() => [
                      createVNode(VCol, null, {
                        default: withCtx(() => [
                          createTextVNode("语言")
                      ...
                      createVNode(VCol, null, {
                        default: withCtx(() => [
                          createVNode(VSwitch, {
                            ...
                            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => isDarkMode.value = $event),
                            class: "float-right",
                            color: "primary"
                          }, null, 8, ["modelValue"])
                        ]),
