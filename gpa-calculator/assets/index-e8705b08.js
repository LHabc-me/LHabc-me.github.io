...
function createOptionsStore(id, options, pinia2, hot2) {
  ...
  store = createSetupStore(id, setup, options, pinia2, hot2, true);
  return store;
}
function createSetupStore($id, setup, options = {}, pinia2, hot2, isOptionsStore) {
  let scope;
...
function deprecate(original2, replacement) {
...
function lighten(value, amount2) {
  const lab = fromXYZ$1(toXYZ(value));
  lab[0] = lab[0] + amount2 * 10;
  return fromXYZ(toXYZ$1(lab));
}
function darken(value, amount2) {
  const lab = fromXYZ$1(toXYZ(value));
  lab[0] = lab[0] - amount2 * 10;
  return fromXYZ(toXYZ$1(lab));
}
...
function internalUseDefaults() {
  ...
  const componentDefaults = computed(() => defaults.value?.[props._as ?? name2]);
...
function createSimpleFunctional(klass) {
  ...
  return genericComponent()({
    name: name2 ?? capitalize$1(camelize(klass.replace(/__/g, "-"))),
    props: {
      tag: {
        type: String,
        default: tag
...
function createTheme(options) {
  ...
  const computedThemes = computed(() => {
    const acc = {};
    for (const [name3, original2] of Object.entries(themes.value)) {
      ...
      if (parsedOptions.variations) {
        for (const name4 of parsedOptions.variations.colors) {
          ...
          for (const variation of ["lighten", "darken"]) {
            ...
            for (const amount2 of createRange(parsedOptions.variations[variation], 1)) {
              theme.colors[`${name4}-${variation}-${amount2}`] = RGBtoHex(fn(parseColor(color), amount2));
            }
          }
        }
      }
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(VThemeProvider, {
        theme: unref(theme).name
      }, {
        default: withCtx(() => [
...
async function loadFonts() {
  const webFontLoader = await __vitePreload(() => import(
    ...
    "./webfontloader-95958a64.js"
  ).then((n) => n.w), true ? [] : void 0, import.meta.url);
  webFontLoader.load({
    google: {
...
function addDays(date2, amount2) {
  const d = new Date(date2);
  d.setDate(d.getDate() + amount2);
  return d;
}
function addMonths(date2, amount2) {
  const d = new Date(date2);
  d.setMonth(d.getMonth() + amount2);
  return d;
}
...
class VuetifyDateAdapter {
  ...
  addDays(date2, amount2) {
    return addDays(date2, amount2);
  }
  addMonths(date2, amount2) {
    return addMonths(date2, amount2);
  }
  getWeekArray(date2) {
...
const generateLayers = (layout, positions, layoutSizes, activeItems) => {
  ...
  for (const id of layout) {
    ...
    const amount2 = layoutSizes.get(id);
    const active = activeItems.get(id);
    if (!position || !amount2 || !active)
      continue;
    const layer = {
      ...previousLayer,
      [position.value]: parseInt(previousLayer[position.value], 10) + (active.value ? parseInt(amount2.value, 10) : 0)
    };
    layers.push({
      id,
      layer
...
const _hoisted_1$1 = { class: "pa-10" };
const _hoisted_2$1 = {
...
const _hoisted_4$1 = { style: { "margin-top": "200px" } };
const _hoisted_5$1 = {
  class: "d-flex mx-auto",
  style: { "width": "150px" }
};
const _hoisted_6 = /* @__PURE__ */ createBaseVNode("span", { class: "text-center justify-center mx-auto" }, " 版本 1.0.0", -1);
const _hoisted_7 = /* @__PURE__ */ createBaseVNode("div", {
  style: { "opacity": "0.7" },
  class: "primary-color text-center mt-3"
}, " MIT Licensed | Copyright © 2023-present LHabc ", -1);
const _sfc_main$1 = {
  __name: "index",
  setup(__props) {
...
if (typeof block0 === "function")
  block0(_sfc_main$1);
const __pages_import_0__ = () => __vitePreload(() => import("./index-be87d6fb.js"), true ? ["./index-be87d6fb.js","./_plugin-vue_export-helper-cc2b3d55.js","./VBtn-4f6b1375.js","./position-c77b8d2a.js","./position-4b591bf3.css","./VBtn-6e3919a3.css"] : void 0, import.meta.url);
const __pages_import_1__ = () => __vitePreload(() => import("./index-7da9439a.js"), true ? ["./index-7da9439a.js","./VTextField-6542153f.js","./position-c77b8d2a.js","./position-4b591bf3.css","./VTextField-c7559fe6.css","./index-a378e701.css"] : void 0, import.meta.url);
const __pages_import_2__ = () => __vitePreload(() => import("./index-aff61402.js"), true ? ["./index-aff61402.js","./VDialog-5c8e4da2.js","./position-c77b8d2a.js","./position-4b591bf3.css","./VTextField-6542153f.js","./VTextField-c7559fe6.css","./VDialog-6bb85032.css","./VBtn-4f6b1375.js","./VBtn-6e3919a3.css"] : void 0, import.meta.url);
const __pages_import_3__ = () => __vitePreload(() => import("./index-77362256.js"), true ? ["./index-77362256.js","./VDialog-5c8e4da2.js","./position-c77b8d2a.js","./position-4b591bf3.css","./VTextField-6542153f.js","./VTextField-c7559fe6.css","./VDialog-6bb85032.css","./VBtn-4f6b1375.js","./VBtn-6e3919a3.css"] : void 0, import.meta.url);
const __pages_import_5__ = () => __vitePreload(() => import("./_...all_-11d46d13.js"), true ? ["./_...all_-11d46d13.js","./_plugin-vue_export-helper-cc2b3d55.js"] : void 0, import.meta.url);
const routes = [{ "name": "error-404", "path": "/error/404", "component": __pages_import_0__, "props": true }, { "name": "settings", "path": "/settings", "component": __pages_import_1__, "props": true, "meta": { "title": "设置" } }, { "name": "rules", "path": "/rules", "component": __pages_import_2__, "props": true, "meta": { "title": "规则" } }, { "name": "calculator", "path": "/calculator", "component": __pages_import_3__, "props": true, "meta": { "title": "计算器" } }, { "name": "index", "path": "/", "component": _sfc_main$1, "props": true, "meta": { "title": "首页" } }, { "name": "all", "path": "/:all(.*)*", "component": __pages_import_5__, "props": true, "meta": { "redirect": "/error/404" } }];
const VApp$1 = "";
...
function useBackButton(router2, cb) {
  ...
  if (IN_BROWSER) {
    nextTick(() => {
      ...
      removeBefore = router2?.beforeEach((to2, from, next) => {
        if (!inTransition) {
...
const classicSelectStrategy = (mandatory) => {
  const strategy = {
    select: (_ref6) => {
      ...
      id = toRaw(id);
      const original2 = new Map(selected);
      const items = [id];
      while (items.length) {
...
const _hoisted_2 = { style: { "width": "160px", "margin-top": "8px" } };
      ...
      return openBlock(), createBlock(VApp, null, {
        default: withCtx(() => [
          createVNode(VAppBar, {
            ...
            prepend: withCtx(() => [
              createBaseVNode("div", _hoisted_2, [
                createBaseVNode("div", _hoisted_3, toDisplayString$1(`${time.value.getHours()}:${time.value.getMinutes()}`), 1),
                createBaseVNode("div", _hoisted_4, toDisplayString$1(`${time.value.getFullYear()}/${time.value.getMonth() + 1}/${time.value.getDate()}`), 1)
              ])
            ]),
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_1, toDisplayString$1(_ctx.$route.meta.title), 1)
            ]),
            _: 1
          }),
          createVNode(VNavigationDrawer, {
            ...
            default: withCtx(() => [
              createVNode(VList, { mandatory: true }, {
                default: withCtx(() => [
                  (openBlock(), createElementBlock(Fragment, null, renderList(menu, (item, index2) => {
                    return createVNode(VListItem, {
                      key: index2,
                      value: index2,
                      active: _ctx.$route.path === item.to,
                      color: "primary",
                      variant: "flat",
                      height: "60",
                      ripple: false,
                      style: normalizeStyle({ opacity: _ctx.$route.path === item.to ? 1 : 0.8 }),
                      onClick: ($event) => _ctx.$router.push(item.to)
                    }, {
                      title: withCtx(() => [
                        createBaseVNode("div", _hoisted_5, toDisplayString$1(item.title), 1)
                      ]),
                      _: 2
                    }, 1032, ["value", "active", "style", "onClick"]);
                  }), 64))
                ]),
                _: 1
              })
...
const layouts = {
  "blank": () => __vitePreload(() => import("./blank-c4dbe381.js"), true ? ["./blank-c4dbe381.js","./_plugin-vue_export-helper-cc2b3d55.js"] : void 0, import.meta.url),
  "default": _sfc_main
};
...
router.beforeEach((to2, from) => {
  if (to2.meta.redirect) {
    return to2.meta.redirect;
  }
  return true;
});
...
function registerPlugins(app2) {
  loadFonts();
  app2.use(vuetify).use(pinia).use(router);
}
/*!
  * shared v9.2.2
...
function defineCoreMissingHandler(missing) {
  return (ctx, locale, key, type2) => {
    return missing(locale, key, getCurrentInstance$1() || void 0, type2);
  };
}
const getMetaInfo = () => {
  const instance = getCurrentInstance$1();
...
const description$1 = "简介";
const detail$1 = "详情";
const email$1 = "电子邮箱";
const expenditure$1 = "支出";
const hot$1 = "热度";
const income$1 = "收入";
const login$1 = "登录";
const logout$1 = "退出登录";
...
const post$1 = "发表";
const price$1 = "价格";
const profile$1 = "个人资料";
const profit$1 = "利润";
const register$1 = "注册";
const required$1 = "必填项";
const salary$1 = "工资";
const send$1 = "发送";
const settings$1 = "设置";
const sort$1 = "排序";
...
const zh_cn = {
  ...
  bonus: bonus$1,
  "book-coins": "书币",
  "book-coins-balance": "书币余额",
  "book-description": "图书简介",
  "book-detail": "书籍详情",
  "book-id": "图书ID",
  "book-manage": "作品管理",
  "book-name": "书名",
  ...
  "book-tags": "图书分类",
  cancel: cancel$1,
  "click-to-upload-book": "点击上传图书",
  "comment-area": "评论区",
  "commit-success-and-hot-increase-1": "评论成功，热度加1",
  confirm: confirm$1,
  "confirm-delete": "确认删除",
  "continue-as-guest": "以游客身份登录",
  date: date$1,
  ...
  "forget-password": "忘记密码？点我找回",
  "home-page": "首页",
  hot: hot$1,
  income: income$1,
  "income-and-expenditure": "收支明细",
  "invalid-email": "无效的电子邮箱",
  "invalid-input": "输入不合法",
  "is-original": "是否原创",
  "labor-costs": "人工成本",
  "length-should-be-between-i-and-j": "长度应该在{i}到{j}之间",
  login: login$1,
  "login-and-continue": "登录后继续浏览",
  "login-failed": "登录失败",
  "login-first": "请先登录",
  "login-success": "登录成功",
  logout: logout$1,
  "manage-books": "管理图书",
  modify: modify$1,
  "modify-book-info": "修改图书信息",
  "modify-fail": "修改失败",
  "modify-success": "修改成功",
  "modify-user-info": "修改用户信息",
  "month-income-and-expenditure": "本月收支",
  "my-collection": "我的书架",
  name: name$1,
  "new-password": "新密码",
  no: no$1,
  "no-description": "暂无简介",
  "no-recent": "还没有开始阅读哦",
  "no-matching-books-found": "没有找到符合条件的图书",
  "not-original": "非原创",
  ...
  "original-author": "原作者",
  password: password$1,
  "please-purchase-this-book-first": "请先购买本书",
  post: post$1,
  "post-comment": "发表评论",
  price: price$1,
  "price-fixing": "定价",
  ...
  "purchase-this-book": "购买本书",
  "recently-read": "最近阅读",
  register: register$1,
  "register-failed": "注册失败",
  "register-success": "注册成功",
  "register-your-account": "注册账号",
  "remember-me": "记住我",
  ...
  salary: salary$1,
  "search-book": "搜索图书",
  "search-by-book-id": "根据图书ID搜索",
  "search-by-book-name": "根据图书名搜索",
  "search-by-uploader-email": "根据上传者邮箱搜索",
  "search-by-uploader-id": "根据上传者ID搜索",
  "search-by-user-email": "根据用户邮箱搜索",
  "search-by-user-id": "根据用户ID搜索",
  "search-user": "搜索用户",
  send: send$1,
  "server-rental-fee": "服务器租赁费",
  settings: settings$1,
  sort: sort$1,
  "tags-cant-contain-comma": "标签不能包含逗号",
  to: to$1,
  topup: topup$1,
  "topup-fail": "充值失败",
  "topup-success": "充值成功",
  "two-passwords-not-match": "两次输入的密码不一致",
  type: type$1,
  upload: upload$1,
  "upload-book": "上传作品",
  "upload-fail": "上传失败",
  "upload-success-hot-increase-10": "上传成功，热度加10",
  "uploader-email": "上传者邮箱",
  "uploader-id": "上传者ID",
  "uploader-name": "上传者用户名",
  user: user$1,
  "user-balance": "用户余额",
  "user-email": "用户邮箱",
  "user-hot": "用户热度",
  ...
  "verification-code-sent": "验证码已发送到您的邮箱，请查收",
  "verification-code-sent-failed": "验证码发送失败，请稍后重试",
  "website-name": "阅读天地",
  "website-welcome": "欢迎来到阅读天地！",
  yes: yes$1,
  "you-have-already-purchased-the-book": "您已购买过该书籍",
  "your-book-coins-are-not-enough-please-top-up": "您的书币不足，请充值"
};
...
const salary = "salary";
const send = "send";
const settings = "set up";
const sort = "sort";
const to = "to";
const topup = "Recharge";
...
const en_us = {
  ...
  "admin-page": "Admin Zone",
  "advanced-search": "Advanced Search",
  "advertising-fee": "advertising fee",
  all,
  "already-have-account": "Already have an account?",
  amount,
  "annual-income": "Annual Profit",
  "annual-income-and-expenditure": "Annual Income and Expenditure",
  articles,
  ascending,
  author,
  "author-description": "About the Author",
  "author-page": "Author Zone",
  back,
  "back-to-login": "Return to login",
  balance,
  "begin-reading": "Start reading",
  bonus,
  "book-coins": "Book Coin",
  "book-coins-balance": "Book Currency Balance",
  "book-description": "Book Introduction",
  "book-detail": "Book Details",
  "book-id": "Book ID",
  "book-manage": "Work Management",
  "book-name": "Book Title",
  "book-price": "Book Price",
  "book-tags": "Book Category",
  cancel,
  "click-to-upload-book": "Click to upload books",
  "comment-area": "comment area",
  "commit-success-and-hot-increase-1": "Successful comments, increase the popularity by 1",
  confirm,
  "confirm-delete": "confirm deletion",
  "continue-as-guest": "Log in as a guest",
  date,
  descending,
  description,
  detail,
  "dont-have-account": "No account yet?",
  email,
  expenditure,
  "forget-password": "Forgot your password? Click me to retrieve it",
  "home-page": "Home Page",
  hot,
  income,
  "income-and-expenditure": "Receipt and Expenditure Details",
  "invalid-email": "Invalid Email",
  "invalid-input": "Illegal input",
  "is-original": "Is it original",
  "labor-costs": "Labor cost",
  "length-should-be-between-i-and-j": "The length should be between {i} and {j}",
  login,
  "login-and-continue": "Continue browsing after logging in",
  ...
  modify,
  "modify-book-info": "Modify book information",
  "modify-fail": "fail to edit",
  "modify-success": "Successfully modified",
  "modify-user-info": "Modify user information",
  "month-income-and-expenditure": "This month's income and expenditure",
  "my-collection": "My Bookshelf",
  name,
  "new-password": "New Password",
  no,
  "no-description": "No Profile",
  "no-recent": "Haven't started reading yet",
  "no-matching-books-found": "No matching books were found",
  "not-original": "non-original",
  operation,
  or,
  original,
  "original-author": "Original Author",
  password,
  "please-purchase-this-book-first": "Please buy this book first",
  post,
  ...
  profile,
  profit,
  "purchase-book": "Buy Books",
  "purchase-fail": "Failed purchase",
  "purchase-success": "Purchased successfully",
  "purchase-this-book": "Buy this book",
  "recently-read": "Recently Read",
  register,
  "register-failed": "registration failed",
  "register-success": "registration success",
  "register-your-account": "Register an account",
  ...
  "sail-book": "Sell Books",
  salary,
  "search-book": "Search Books",
  "search-by-book-id": "Search by Book ID",
  "search-by-book-name": "Search by Book Title",
  "search-by-uploader-email": "Search by uploader email",
  "search-by-uploader-id": "Search by uploader ID",
  "search-by-user-email": "Search by user email",
  "search-by-user-id": "Search by user ID",
  "search-user": "Search Users",
  send,
  "server-rental-fee": "Server Rental Fee",
  settings,
  sort,
  "tags-cant-contain-comma": "Tags cannot contain commas",
  to,
  topup,
  "topup-fail": "Recharge failed",
  "topup-success": "Recharge successful",
  "two-passwords-not-match": "The passwords entered twice are inconsistent",
  type,
  upload,
  "upload-book": "Upload works",
  "upload-fail": "upload failed",
  "upload-success-hot-increase-10": "Upload is successful, increase the popularity by 10",
  ...
  "user-hot": "User Popularity",
  "user-id": "User ID",
  "user-manage": "User Management",
  "user-name": "username",
  "user-page": "Readers Zone",
  username,
  "verification-code": "Verification Code",
  "verification-code-sent": "The verification code has been sent to your email, please check it",
  "verification-code-sent-failed": "Failed to send verification code, please try again later",
  "website-name": "Reading World",
  "website-welcome": "Welcome to Reading World!",
  yes,
  "you-have-already-purchased-the-book": "You have already purchased this book",
  "your-book-coins-are-not-enough-please-top-up": "Your book currency is insufficient, please recharge"
};
const messages = {
  zh_cn,
  en_us
    ...
    return (
      ...
      (() => {
        ...
        (() => {
          ...
          const _hoisted_12 = /* @__PURE__ */ (0, external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createElementVNode)("div", {
            class: "v-toast__icon"
          }, null, -1);
          ...
          function render2(_ctx, _cache, $props, $setup, $data, $options) {
            return (0, external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.openBlock)(), (0, external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createBlock)(external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.Transition, {
              ...
              }, [_hoisted_12, (0, external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createElementVNode)("p", {
                class: "v-toast__text",
                innerHTML: _ctx.message
              }, null, 8, _hoisted_22)], 34), [[external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.vShow, _ctx.isActive]])]),
              _: 1
          ...
          const __exports__ = /* @__PURE__ */ (0, exportHelper["default"])(Componentvue_type_script_lang_js, [["render", render2]]);
          ...
          const ToastPlugin2 = {
            install: function(app2) {
              ...
              app2.config.globalProperties.$toast = instance;
              app2.provide("$toast", instance);
            }
          };
          const src = ToastPlugin2;
        })();
...
const ToastPlugin = /* @__PURE__ */ getDefaultExportFromCjs(distExports);
const global$1 = "";
const fonts = "";
...
export {
  ...
  createRange as ad,
  clamp as ae,
  makeDimensionProps as af,
  getCurrentInstance as ag,
  useDimension as ah,
  useToggleScope as ai,
  convertToUnit as aj,
  onMounted as ak,
  makeItemsProps as al,
  makeTransitionProps as am,
  useItems as an,
  VList as ao,
  VListItem as ap,
  ...
  renderList as av,
  createBlock as aw,
  toDisplayString$1 as ax,
  createSimpleFunctional as ay,
  distExports as az,
  ...
  cloneVNode as b3,
  callEvent as b4,
  findChildrenWithProvide as b5,
  SUPPORTS_INTERSECTION as b6,
  resolveComponent as b7,
  KeepAlive as b8,
  resolveDynamicComponent as b9,
  VMain as ba,
  VApp as bb,
